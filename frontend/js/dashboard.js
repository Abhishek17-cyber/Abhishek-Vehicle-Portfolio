      ...
      itemsDiv.innerHTML = alerts.map(v => {
        ...
        return `
          <div class="mb-1">
            ...
            <br>
            <span class="text-muted"><i class="bi bi-person me-1"></i>${v.owner_name || 'N/A'} <i class="bi bi-telephone ms-1 me-1"></i><a href="tel:${v.owner_phone}" class="text-decoration-none">${v.owner_phone || 'N/A'}</a></span>
          </div>`;
      }).join('');
